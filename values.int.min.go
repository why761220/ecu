...
type intMinValue int64

func (this intMinValue) Format(fmt string) string {
	if this.Nil() {
		return ""
	}
...
type intMinValues struct {
	values
	slices [][]int64
}

func (this intMinValues) ToSlice(rows Positions) interface{} {
...
func (this intMinValues) init() (Values, error) {
	return this, nil
}

func (this intMinValues) load(r *bufio.Reader, max int, add bool) (Values, error) {
	if add {
...
func (this intMinValues) Save(w io.Writer) (err error) {
...
func (i intMinValue) Type() DataType {
	return TypeIntMin
}

func (i intMinValue) Base() interface{} {
	if i.Nil() {
		return nil
	}
	return i.Int()
...
func (i intMinValue) Nil() bool {
	return i == math.MaxInt64
}

func (i intMinValue) Bool() bool {
	panic("implement me")
}

func (i intMinValue) Int() int64 {
	return int64(i)
}

func (i intMinValue) int1() int64 {
	return i.Int()
}

func (i intMinValue) int2() int64 {
	panic("implement me")
}

func (i intMinValue) Float() float64 {
	return float64(i.Int())
}

func (i intMinValue) float1() float64 {
	return i.Float()
}

func (i intMinValue) float2() float64 {
	panic("implement me")
}

func (i intMinValue) Str() string {
	if i.Nil() {
		return ""
	}
...
func (i intMinValue) any2() interface{} {
	panic("implement me")
}

func (intMinValues) Type() DataType {
	return TypeIntMin
}
func (intMinValues) alloc(l int) []int64 {
	return intSlicePool.Get().([]int64)[0:l]
}
func (intMinValues) release(v []int64) {
	intSlicePool.Put(v)
}
func (intMinValues) nil() int64 {
	return math.MinInt64
}
func (this intMinValues) value(v int64) Value {
	if v == this.nil() {
		return Nil
	} else {
		return intMinValue(v)
	}
}
func (this intMinValues) Resize(size int) Values {
	if size <= 0 {
...
func (this intMinValues) add(v int64) Values {
...
func (this intMinValues) Add(getter Getter) (Values, error) {
...
func (this intMinValues) set(agg bool, pos int, v int64) (Values, Cancel, error) {
...
func (this intMinValues) Set(pos int, v Value, merge bool) (Values, Cancel, error) {
...
func (this intMinValues) Get(pos int) Value {
	if m, n := mn(pos); m >= 0 && m < len(this.slices) {
...
func (this intMinValues) tof() (ret floatMinValues) {
	ret.values = this.values
	ret.values.DataType = TypeFloatMin
